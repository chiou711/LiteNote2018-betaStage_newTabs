...
// Pager adapter
public class Page_newAdapter extends SimpleDragSortCursorAdapter//BaseAdapter
{
	FragmentActivity mAct;
    DB_page mDb_page;
    int number;
    ArrayList<Integer> list;
	Page_newAdapter(Context context, int layout, Cursor c,
...
//    public Page_newAdapter(FragmentActivity c, ArrayList<Integer> _list) {
//        this.mAct = c;
//        this.list = _list;
//    }
